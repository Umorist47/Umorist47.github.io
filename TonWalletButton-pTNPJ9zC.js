...
function y$1(R, $, W) {
    ...
    if (arguments.length > 2 && (Y.children = arguments.length > 3 ? n$1.call(arguments, 2) : W), typeof R == "function" && R.defaultProps != null)
...
function k$1(R) {
    ...
    if ((R = R.__) != null && R.__c != null) {
        for (R.__e = R.__c.base = null, $ = 0; $ < R.__k.length; $++)
            if ((W = R.__k[$]) != null && W.__e != null) {
...
function x$1() {
    ...
    for (i$3.sort(f$3); R = i$3.shift();)
        R.__d && ($ = i$3.length, U = void 0, K = (V = (W = R).__v).__e, Z = [], J = [], (Y = W.__P) && ((U = v$2({}, V)).__v = V.__v + 1, l$4.vnode && l$4.vnode(U), L$1(Y, U, V, W.__n, Y.ownerSVGElement !== void 0, 32 & V.__u ? [K] : null, Z, K ?? m$1(V), !!(32 & V.__u), J), U.__.__k[U.__i] = U, M(Z, U, J), U.__e != K && k$1(U)), i$3.length > $ && i$3.sort(f$3));
    x$1.__r = 0
}
...
function P$1(R, $, W) {
    ...
    for (R.__k = [], U = 0; U < J; U++)
        (V = R.__k[U] = (V = $[U]) == null || typeof V == "boolean" || typeof V == "function" ? null : typeof V == "string" || typeof V == "number" || typeof V == "bigint" || V.constructor == String ? d$3(null, V, null, null, V) : h$2(V) ? d$3(g$2, {
            children: V
        }, null, null, null) : V.constructor === void 0 && V.__b > 0 ? d$3(V.type, V.props, V.key, V.ref ? V.ref : null, V.__v) : V) != null ? (V.__ = R, V.__b = R.__b + 1, Z = H(V, W, Y = U + re, oe), V.__i = Z, K = null, Z !== -1 && (oe--, (K = W[Z]) && (K.__u |= 131072)), K == null || K.__v === null ? (Z == -1 && re--, typeof V.type != "function" && (V.__u |= 65536)) : Z !== Y && (Z === Y + 1 ? re++ : Z > Y ? oe > J - Y ? re += Z - Y : re-- : re = Z < Y && Z == Y - 1 ? Z - Y : 0, Z !== U + re && (V.__u |= 65536))) : (K = W[U]) && K.key == null && K.__e && (K.__e == R.__d && (R.__d = m$1(K)), N(K, K, !1), W[U] = null, oe--);
    if (oe)
        for (U = 0; U < X; U++)
            (K = W[U]) != null && !(131072 & K.__u) && (K.__e == R.__d && (R.__d = m$1(K)), N(K, K))
}
function S(R, $, W) {
    var U,
        V;
    if (typeof R.type == "function") {
        for (U = R.__k, V = 0; U && V < U.length; V++)
            U[V] && (U[V].__ = R, $ = S(U[V], $, W));
        return $
    }
    ...
    e:
        if ($ === "style")
            if (typeof W == "string")
                ...
                if (typeof U == "string" && (R.style.cssText = U = ""), U)
                    for ($ in U)
                        W && $ in W || I(R.style, $, "");
                if (W)
                    for ($ in W)
        ...
        R.l || (R.l = {}),
        R.l[$ + K] = W,
        W ? U ? W.u = U.u : (W.u = Date.now(), R.addEventListener($, K ? D : A, K)) : R.removeEventListener($, K ? D : A, K);
    else {
        if (V)
        ...
        if (typeof de == "function")
            try {
                if (Re = $.props, Se = (oe = de.contextType) && U[oe.__c], Ee = oe ? Se ? Se.props.value : oe.__ : U, W.__c ? pe = (re = $.__c = W.__c).__ = re.__E : ("prototype" in de && de.prototype.render ? $.__c = re = new de(Re, Ee) : ($.__c = re = new b$2(Re, Ee), re.constructor = de, re.render = O$1), Se && Se.sub(re), re.props = Re, re.state || (re.state = {}), re.context = Ee, re.__n = U, ie = re.__d = !0, re.__h = [], re._sb = []), re.__s == null && (re.__s = re.state), de.getDerivedStateFromProps != null && (re.__s == re.state && (re.__s = v$2({}, re.__s)), v$2(re.__s, de.getDerivedStateFromProps(Re, re.__s))), se = re.props, le = re.state, re.__v = $, ie)
                    ...
                    if (de.getDerivedStateFromProps == null && Re !== se && re.componentWillReceiveProps != null && re.componentWillReceiveProps(Re, Ee), !re.__e && (re.shouldComponentUpdate != null && re.shouldComponentUpdate(Re, re.__s, Ee) === !1 || $.__v === W.__v)) {
                        for ($.__v !== W.__v && (re.props = Re, re.state = re.__s, re.__d = !1), $.__e = W.__e, $.__k = W.__k, $.__k.forEach(function (xe) {
                                xe && (xe.__ = $)
                            }), Be = 0; Be < re._sb.length; Be++)
                            re.__h.push(re._sb[Be]);
                        re._sb = [],
                            re.__h.length && Y.push(re);
                        break e
                    }
                    re.componentWillUpdate != null && re.componentWillUpdate(Re, re.__s, Ee),
                        re.componentDidUpdate != null && re.__h.push(function () {
                ...
                if (re.context = Ee, re.props = Re, re.__P = R, re.__e = !1, we = l$4.__r, Pe = 0, "prototype" in de && de.prototype.render) {
                    for (re.state = re.__s, re.__d = !1, we && we($), oe = re.render(re.props, re.state, re.context), be = 0; be < re._sb.length; be++)
                        re.__h.push(re._sb[be]);
                    re._sb = []
                } else
                    do re.__d = !1,
                        we && we($),
                        oe = re.render(re.props, re.state, re.context),
                        re.state = re.__s;
                    while (re.__d && ++Pe < 25);
                re.state = re.__s,
                    re.getChildContext != null && (U = v$2(v$2({}, U), re.getChildContext())),
                    ie || re.getSnapshotBeforeUpdate == null || (ue = re.getSnapshotBeforeUpdate(se, le)),
                    C(R, h$2(ye = oe != null && oe.type === g$2 && oe.key == null ? oe.props.children : oe) ? ye : [ye], $, W, U, V, K, Y, Z, J, X),
                    re.base = $.__e,
                    $.__u &= -161,
                    re.__h.length && Y.push(re),
                    pe && (re.__E = re.__ = null)
            } catch (xe) {
                $.__v = null,
                    J || K != null ? ($.__e = Z, $.__u |= J ? 160 : 32, K[K.indexOf(Z)] = null) : ($.__e = W.__e, $.__k = W.__k),
                    l$4.__e(xe, $, W)
            }
    else
        K == null && $.__v === W.__v ? ($.__k = W.__k, $.__e = W.__e) : $.__e = j$1(W.__e, $, W, U, V, K, Y, J, X);
    (oe = l$4.diffed) && oe($)
}
function M(R, $, W) {
    $.__d = void 0;
...
function j$1(R, $, W, U, V, K, Y, Z, J) {
    ...
    if (Se === "svg" && (V = !0), K != null) {
        for (X = 0; X < K.length; X++)
            if ((se = K[X]) && "setAttribute" in se == !!Se && (Se ? se.localName === Se : se.nodeType === 3)) {
                R = se,
                    K[X] = null;
                break
            }
    ...
    if (R == null) {
        ...
        R = V ? document.createElementNS("http://www.w3.org/2000/svg", Se) : document.createElement(Se, Re.is && Re),
            K = null,
            Z = !1
    }
    if (Se === null)
        pe === Re || Z && R.data === Re || (R.data = Re);
    else {
        if (K = K && n$1.call(R.childNodes), pe = W.props || c$3, !Z && K != null)
            for (pe = {}, X = 0; X < R.attributes.length; X++)
                pe[(se = R.attributes[X]).name] = se.value;
        for (X in pe)
            se = pe[X],
            X == "children" || (X == "dangerouslySetInnerHTML" ? re = se : X === "key" || X in Re || T$1(R, X, null, se, V));
        for (X in Re)
            se = Re[X],
            X == "children" ? ie = se : X == "dangerouslySetInnerHTML" ? oe = se : X == "value" ? le = se : X == "checked" ? ue = se : X === "key" || Z && typeof se != "function" || pe[X] === se || T$1(R, X, se, pe[X], V);
        if (oe)
            Z || re && (oe.__html === re.__html || oe.__html === R.innerHTML) || (R.innerHTML = oe.__html),
            $.__k = [];
        else if (re && (R.innerHTML = ""), C(R, h$2(ie) ? ie : [ie], $, W, U, V && Se !== "foreignObject", K, Y, K ? K[0] : W.__k && m$1(W, 0), Z, J), K != null)
            for (X = K.length; X--;)
                K[X] != null && p$4(K[X]);
...
n$1 = s$3.slice,
    l$4 = {
        __e: function (R, $, W, U) {
            for (var V, K, Y; $ = $.__;)
                if ((V = $.__c) && !V.__)
                    try {
                        if ((K = V.constructor) && K.getDerivedStateFromError != null && (V.setState(K.getDerivedStateFromError(R)), Y = V.__d), V.componentDidCatch != null && (V.componentDidCatch(R, U || {}), Y = V.__d), Y)
                            return V.__E = V
                    } catch (Z) {
                        R = Z
                    }
    ...
    b$2.prototype.setState = function (R, $) {
        ...
        W = this.__s != null && this.__s !== this.state ? this.__s : this.__s = v$2({}, this.state),
            ...
            R && v$2(W, R),
            R != null && this.__v && ($ && this._sb.push($), w$2(this))
    },
...
Ue(an, "formatter", new SimpleFormatter),
    Ue(an, "disabled", !1),
    Ue(an, "onelineStackTrace", !1);
let Log = an;
...
class SecureUtil {
    static makeRandomString($, W = this.defaultChars) {
        ...
        const V = W.length;
        for (let K = 0; K < $; K++)
            U += W.charAt(Math.floor(Math.random() * V));
        return U
    }
}
Ue(SecureUtil, "readableChars", "ABCDEFGHJKLMNPQRSTUVWXYZ23456789"),
    Ue(SecureUtil, "defaultChars", "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");
...
Ue(_n, "network_error", "network_error"),
    Ue(_n, "parse_error", "parse_error");
let ApiError = _n;
class ApiCall {
    constructor($, W) {
        Ue(this, "_context");
    ...
    makeHeaders($, W) {
        ...
        const U = {};
        return U["Content-Type"] = "application/json", $ && (U.Authorization = `Bearer ${$}`), this._context.headers.forEach((V, K) => U[K] = V), {
            ...U,
            ...W
        }
    }
    async get($, W, U) {
        ...
        if (Y instanceof ApiError)
            throw this._context.callErrorHandler(Y), Y;
        return Y
    }
    async post($, W, U) {
        const V = this.makeUrl();
...
class TapokAPI {
    constructor($) {
        Ue(this, "_context", new ApiContext({
            tag: "tap_api"
        }));
    ...
    l$4.__r = function (R) {
        ...
        $ && (u$3 === r$1 ? ($.__h = [], r$1.__h = [], $.__.forEach(function (W) {
                W.__N && (W.__ = W.__N),
                    W.__V = c$2,
                    W.__N = W.i = void 0
            })) : ($.__h.forEach(k), $.__h.forEach(w$1), $.__h = [], t$2 = 0)),
            u$3 = r$1
    },
...
function k(R) {
    var $ = r$1,
        W = R.__c;
    typeof W == "function" && (R.__c = void 0, W()),
        r$1 = $
}
function w$1(R) {
    var $ = r$1;
    ...
    if (v > 1)
        ...
        for (var R, $ = !1; f$1 !== void 0;) {
            ...
            for (f$1 = void 0, e$1++; W !== void 0;) {
                var U = W.o;
                if (W.o = void 0, W.f &= -3, !(8 & W.f) && l$2(W))
                    try {
                        W.c()
                    } catch (V) {
                        $ || (R = V, $ = !0)
...
function c$1(R) {
    if (o$1 !== void 0) {
        ...
        if ($.i === -1)
            return $.i = 0, $.n !== void 0 && ($.n.p = $.p, $.p !== void 0 && ($.p.n = $.n), $.p = o$1.s, $.n = void 0, o$1.s.n = $, o$1.s = $), $
    }
}
function d$1(R) {
    this.v = R,
...
d$1.prototype.U = function (R) {
    if (this.t !== void 0) {
        var $ = R.e,
            W = R.x;
        $ !== void 0 && ($.x = W, R.e = void 0),
            W !== void 0 && (W.e = $, R.x = void 0),
            R === this.t && (this.t = W)
    }
};
...
function w(R) {
    for (var $ = R.s, W = void 0; $ !== void 0;) {
        var U = $.p;
        $.i === -1 ? ($.S.U($), U !== void 0 && (U.n = $.n), $.n !== void 0 && ($.n.p = U)) : W = $,
            $.S.n = $.r,
            $.r !== void 0 && ($.r = void 0),
            $ = U
    }
...
(_$1.prototype = new d$1).h = function () {
    if (this.f &= -3, 1 & this.f)
        return !1;
    if ((36 & this.f) == 32 || (this.f &= -5, this.g === u$2))
        return !0;
    if (this.g = u$2, this.f |= 1, this.i > 0 && !l$2(this))
        return this.f &= -2, !0;
    var R = o$1;
    try {
        y(this),
...
(function (R) {
    (function ($, W) {
        ...
        return $.decodeUTF8 = function (U) {
            ...
            var V,
                K = unescape(encodeURIComponent(U)),
    ...
    (function ($) {
        ...
        function be(Q, te, ee, G, ne, fe, ge) {
            ...
            for (Ke = 0; Ke < 8; Ke++)
                Ae[Ke] = fe[Ke];
            for (; ne >= 64;) {
                for (Be(Fe, Ae, ge, Pe), Ke = 0; Ke < 64; Ke++)
                    Q[te + Ke] = ee[G + Ke] ^ Fe[Ke];
                for (Qe = 1, Ke = 8; Ke < 16; Ke++)
                    Qe = Qe + (Ae[Ke] & 255) | 0,
                    Ae[Ke] = Qe & 255,
                    Qe >>>= 8;
                ne -= 64,
            ...
            if (ne > 0)
                for (Be(Fe, Ae, ge, Pe), Ke = 0; Ke < ne; Ke++)
                    Q[te + Ke] = ee[G + Ke] ^ Fe[Ke];
            return 0
        }
        function ye(Q, te, ee, G, ne) {
            ...
            for (Fe = 0; Fe < 8; Fe++)
                fe[Fe] = G[Fe];
            for (; ee >= 64;) {
                for (Be(ge, fe, ne, Pe), Fe = 0; Fe < 64; Fe++)
                    Q[te + Fe] = ge[Fe];
                for (Ae = 1, Fe = 8; Fe < 16; Fe++)
                    Ae = Ae + (fe[Fe] & 255) | 0,
                    fe[Fe] = Ae & 255,
                    Ae >>>= 8;
                ee -= 64,
            ...
            if (ee > 0)
                for (Be(ge, fe, ne, Pe), Fe = 0; Fe < ee; Fe++)
                    Q[te + Fe] = ge[Fe];
            return 0
        }
        function de(Q, te, ee, G, ne) {
            ...
            we(fe, G, ne, Pe);
            for (var ge = new Uint8Array(8), Ae = 0; Ae < 8; Ae++)
                ge[Ae] = G[Ae + 16];
        ...
        var he = function (Q) {
            ...
            te = Q[0] & 255 | (Q[1] & 255) << 8,
                ...
                Ae = Q[12] & 255 | (Q[13] & 255) << 8,
                this.r[7] = (ge >>> 11 | Ae << 5) & 8065,
                Fe = Q[14] & 255 | (Q[15] & 255) << 8,
                this.r[8] = (Ae >>> 8 | Fe << 8) & 8191,
                this.r[9] = Fe >>> 5 & 127,
        ...
        he.prototype.blocks = function (Q, te, ee) {
            ...
            he.prototype.finish = function (Q, te) {
                ...
                for (G = this.h[1] >>> 13, this.h[1] &= 8191, ge = 2; ge < 10; ge++)
                    this.h[ge] += G,
                    G = this.h[ge] >>> 13,
                    this.h[ge] &= 8191;
                for (this.h[0] += G * 5, G = this.h[0] >>> 13, this.h[0] &= 8191, this.h[1] += G, G = this.h[1] >>> 13, this.h[1] &= 8191, this.h[2] += G, ee[0] = this.h[0] + 5, G = ee[0] >>> 13, ee[0] &= 8191, ge = 1; ge < 10; ge++)
                    ee[ge] = this.h[ge] + G,
                    G = ee[ge] >>> 13,
                    ee[ge] &= 8191;
                for (ee[9] -= 8192, ne = (G ^ 1) - 1, ge = 0; ge < 10; ge++)
                    ee[ge] &= ne;
                for (ne = ~ne, ge = 0; ge < 10; ge++)
                    this.h[ge] = this.h[ge] & ne | ee[ge];
                for (this.h[0] = (this.h[0] | this.h[1] << 13) & 65535, this.h[1] = (this.h[1] >>> 3 | this.h[2] << 10) & 65535, this.h[2] = (this.h[2] >>> 6 | this.h[3] << 7) & 65535, this.h[3] = (this.h[3] >>> 9 | this.h[4] << 4) & 65535, this.h[4] = (this.h[4] >>> 12 | this.h[5] << 1 | this.h[6] << 14) & 65535, this.h[5] = (this.h[6] >>> 2 | this.h[7] << 11) & 65535, this.h[6] = (this.h[7] >>> 5 | this.h[8] << 8) & 65535, this.h[7] = (this.h[8] >>> 8 | this.h[9] << 5) & 65535, fe = this.h[0] + this.pad[0], this.h[0] = fe & 65535, ge = 1; ge < 8; ge++)
            ...
            he.prototype.update = function (Q, te, ee) {
                var G,
                    ne;
                if (this.leftover) {
                    for (ne = 16 - this.leftover, ne > ee && (ne = ee), G = 0; G < ne; G++)
                        this.buffer[this.leftover + G] = Q[te + G];
                    if (ee -= ne, te += ne, this.leftover += ne, this.leftover < 16)
                        return;
                    this.blocks(this.buffer, 0, 16),
                        this.leftover = 0
                }
        ...
        function We(Q, te, ee, G, ne) {
            ...
            if (ee < 32)
                return -1;
            for (xe(Q, 0, te, 0, ee, G, ne), ce(Q, 16, Q, 32, ee - 32, Q), fe = 0; fe < 16; fe++)
                Q[fe] = 0;
            return 0
        }
        function He(Q, te, ee, G, ne) {
            var fe,
                ge = new Uint8Array(32);
            if (ee < 32 || (de(ge, 0, 32, G, ne), Oe(te, 16, te, 32, ee - 32, ge) !== 0))
                return -1;
            for (xe(Q, 0, te, 0, ee, G, ne), fe = 0; fe < 32; fe++)
                Q[fe] = 0;
            return 0
        }
        function tt(Q, te) {
        ...
        function At(Q, te) {
            ...
            for (at(ge), at(ge), at(ge), G = 0; G < 2; G++) {
                for (fe[0] = ge[0] - 65517, ee = 1; ee < 15; ee++)
        ...
        function Te(Q, te, ee) {
            ...
            for (ge = 0; ge < 31; ge++)
                G[ge] = te[ge];
            for (G[31] = te[31] & 127 | 64, G[0] &= 248, Vt(ne, ee), ge = 0; ge < 16; ge++)
                Fe[ge] = ne[ge],
                Ke[ge] = Ae[ge] = Qe[ge] = 0;
            for (Ae[0] = Ke[0] = 1, ge = 254; ge >= 0; --ge)
                fe = G[ge >>> 3] >>> (ge & 7) & 1,
                Ct(Ae, Fe, fe),
                Ct(Qe, Ke, fe),
                Bt($t, Ae, Qe),
                ...
                for (Ze = 0; Ze < 80; Ze++)
                    if (ge = nt, Ae = mt, Fe = yt, Qe = vt, Ke = ae, $t = wt, Ge = Tt, it = kt, lt = _t, pt = St, ht = Et, ct = Ft, ut = It, dt = Ut, ze = Ot, Je = Dt, me = kt, ve = Dt, Ne = ve & 65535, ke = ve >>> 16, Me = me & 65535, De = me >>> 16, me = (ae >>> 14 | It << 18) ^ (ae >>> 18 | It << 14) ^ (It >>> 9 | ae << 23), ve = (It >>> 14 | ae << 18) ^ (It >>> 18 | ae << 14) ^ (ae >>> 9 | It << 23), Ne += ve & 65535, ke += ve >>> 16, Me += me & 65535, De += me >>> 16, me = ae & wt ^ ~ae & Tt, ve = It & Ut ^ ~It & Ot, Ne += ve & 65535, ke += ve >>> 16, Me += me & 65535, De += me >>> 16, me = Rt[Ze * 2], ve = Rt[Ze * 2 + 1], Ne += ve & 65535, ke += ve >>> 16, Me += me & 65535, De += me >>> 16, me = ne[Ze % 16], ve = fe[Ze % 16], Ne += ve & 65535, ke += ve >>> 16, Me += me & 65535, De += me >>> 16, ke += Ne >>> 16, Me += ke >>> 16, De += Me >>> 16, qe = Me & 65535 | De << 16, Ye = Ne & 65535 | ke << 16, me = qe, ve = Ye, Ne = ve & 65535, ke = ve >>> 16, Me = me & 65535, De = me >>> 16, me = (nt >>> 28 | _t << 4) ^ (_t >>> 2 | nt << 30) ^ (_t >>> 7 | nt << 25), ve = (_t >>> 28 | nt << 4) ^ (nt >>> 2 | _t << 30) ^ (nt >>> 7 | _t << 25), Ne += ve & 65535, ke += ve >>> 16, Me += me & 65535, De += me >>> 16, me = nt & mt ^ nt & yt ^ mt & yt, ve = _t & St ^ _t & Et ^ St & Et, Ne += ve & 65535, ke += ve >>> 16, Me += me & 65535, De += me >>> 16, ke += Ne >>> 16, Me += ke >>> 16, De += Me >>> 16, it = Me & 65535 | De << 16, Je = Ne & 65535 | ke << 16, me = Qe, ve = ct, Ne = ve & 65535, ke = ve >>> 16, Me = me & 65535, De = me >>> 16, me = qe, ve = Ye, Ne += ve & 65535, ke += ve >>> 16, Me += me & 65535, De += me >>> 16, ke += Ne >>> 16, Me += ke >>> 16, De += Me >>> 16, Qe = Me & 65535 | De << 16, ct = Ne & 65535 | ke << 16, mt = ge, yt = Ae, vt = Fe, ae = Qe, wt = Ke, Tt = $t, kt = Ge, nt = it, St = lt, Et = pt, Ft = ht, It = ct, Ut = ut, Ot = dt, Dt = ze, _t = Je, Ze % 16 === 15)
                        for (Ve = 0; Ve < 16; Ve++)
                            ...
                            Me += ke >>> 16,
                            De += Me >>> 16,
                            ne[Ve] = Me & 65535 | De << 16,
                            fe[Ve] = Ne & 65535 | ke << 16;
                me = nt,
                    ve = _t,
                    Ne = ve & 65535,
                    ke = ve >>> 16,
                    ...
                    Me += ke >>> 16,
                    De += Me >>> 16,
                    Q[0] = nt = Me & 65535 | De << 16,
                    te[0] = _t = Ne & 65535 | ke << 16,
                    me = mt,
                    ve = St,
                    Ne = ve & 65535,
                    ke = ve >>> 16,
                    ...
                    Me += ke >>> 16,
                    De += Me >>> 16,
                    Q[1] = mt = Me & 65535 | De << 16,
                    te[1] = St = Ne & 65535 | ke << 16,
                    me = yt,
                    ve = Et,
                    Ne = ve & 65535,
                    ke = ve >>> 16,
                    ...
                    Me += ke >>> 16,
                    De += Me >>> 16,
                    Q[2] = yt = Me & 65535 | De << 16,
                    te[2] = Et = Ne & 65535 | ke << 16,
                    me = vt,
                    ve = Ft,
                    Ne = ve & 65535,
                    ke = ve >>> 16,
                    ...
                    Me += ke >>> 16,
                    De += Me >>> 16,
                    Q[3] = vt = Me & 65535 | De << 16,
                    te[3] = Ft = Ne & 65535 | ke << 16,
                    me = ae,
                    ve = It,
                    Ne = ve & 65535,
                    ke = ve >>> 16,
                    ...
                    Me += ke >>> 16,
                    De += Me >>> 16,
                    Q[4] = ae = Me & 65535 | De << 16,
                    te[4] = It = Ne & 65535 | ke << 16,
                    me = wt,
                    ve = Ut,
                    Ne = ve & 65535,
                    ke = ve >>> 16,
                    ...
                    Me += ke >>> 16,
                    De += Me >>> 16,
                    Q[5] = wt = Me & 65535 | De << 16,
                    te[5] = Ut = Ne & 65535 | ke << 16,
                    me = Tt,
                    ve = Ot,
                    Ne = ve & 65535,
                    ke = ve >>> 16,
                    ...
                    Me += ke >>> 16,
                    De += Me >>> 16,
                    Q[6] = Tt = Me & 65535 | De << 16,
                    te[6] = Ot = Ne & 65535 | ke << 16,
                    me = kt,
                    ve = Dt,
                    Ne = ve & 65535,
                    ke = ve >>> 16,
                    ...
                    Me += ke >>> 16,
                    De += Me >>> 16,
                    Q[7] = kt = Me & 65535 | De << 16,
                    te[7] = Dt = Ne & 65535 | ke << 16,
                    Kt += 128,
                    G -= 128
            }
            return G
        ...
        function Wt(Q, te, ee) {
            var G = new Int32Array(8),
                ne = new Int32Array(8),
                fe = new Uint8Array(256),
                ge,
                Ae = ee;
            for (G[0] = 1779033703, G[1] = 3144134277, G[2] = 1013904242, G[3] = 2773480762, G[4] = 1359893119, G[5] = 2600822924, G[6] = 528734635, G[7] = 1541459225, ne[0] = 4089235720, ne[1] = 2227873595, ne[2] = 4271175723, ne[3] = 1595750129, ne[4] = 2917565137, ne[5] = 725511199, ne[6] = 4215389547, ne[7] = 327033209, rt(G, ne, te, ee), ee %= 128, ge = 0; ge < ee; ge++)
                fe[ge] = te[Ae - ee + ge];
            for (fe[ee] = 128, ee = 256 - 128 * (ee < 112 ? 1 : 0), fe[ee - 9] = 0, le(fe, ee - 8, Ae / 536870912 | 0, Ae << 3), rt(G, ne, fe, ee), ge = 0; ge < 8; ge++)
        ...
        function Jt(Q, te, ee) {
            var G,
                ne;
            for (tt(Q[0], Y), tt(Q[1], Z), tt(Q[2], Z), tt(Q[3], Y), ne = 255; ne >= 0; --ne)
                G = ee[ne / 8 | 0] >> (ne & 7) & 1,
                fn(Q, te, G),
                jt(te, Q),
                jt(Q, Q),
        ...
        function ft(Q, te, ee) {
            var G = new Uint8Array(64),
                ne = [W(), W(), W(), W()],
                fe;
            for (ee || U(te, 32), Wt(G, te, 32), G[0] &= 248, G[31] &= 127, G[31] |= 64, Xt(ne, G), qt(Q, ne), fe = 0; fe < 32; fe++)
                te[fe + 32] = Q[fe];
            return 0
        }
        ...
        function st(Q, te) {
            var ee,
                ...
                fe;
            for (G = 63; G >= 32; --G) {
                for (ee = 0, ne = G - 32, fe = G - 12; ne < fe; ++ne)
        ...
        function nn(Q, te, ee, G) {
            var ne = new Uint8Array(64),
                fe = new Uint8Array(64),
                ge = new Uint8Array(64),
                Ae,
                Fe,
                Qe = new Float64Array(64),
                Ke = [W(), W(), W(), W()];
            Wt(ne, G, 32),
                ne[0] &= 248,
                ne[31] &= 127,
            ...
            for (Ae = 0; Ae < 32; Ae++)
                Q[32 + Ae] = ne[32 + Ae];
            for (Wt(ge, Q.subarray(32), ee + 32), Lt(ge), Xt(Ke, ge), qt(Q, Ke), Ae = 32; Ae < 64; Ae++)
                Q[Ae] = G[Ae];
            for (Wt(fe, Q, ee + 64), Lt(fe), Ae = 0; Ae < 64; Ae++)
                Qe[Ae] = 0;
            for (Ae = 0; Ae < 32; Ae++)
                Qe[Ae] = ge[Ae];
            for (Ae = 0; Ae < 32; Ae++)
                for (Fe = 0; Fe < 32; Fe++)
                    Qe[Ae + Fe] += fe[Ae] * ne[Fe];
        ...
        $.randomBytes = function (Q) {
            ...
            $.sign.detached.verify = function (Q, te, ee) {
                if (tn(Q, te, ee), te.length !== dn)
                    throw new Error("bad signature size");
                if (ee.length !== hn)
                    throw new Error("bad public key size");
                var G = new Uint8Array(dn + Q.length),
                    ne = new Uint8Array(dn + Q.length),
                    fe;
                for (fe = 0; fe < dn; fe++)
                    G[fe] = te[fe];
            ...
            function () {
                ...
                if (Q && Q.getRandomValues) {
                    ...
                    typeof commonjsRequire < "u" && (Q = require$$0, Q && Q.randomBytes && $.setPRNG(function (ee, G) {
                        var ne,
                            fe = Q.randomBytes(G);
                        for (ne = 0; ne < G; ne++)
                            ee[ne] = fe[ne];
...
function createResource$1(R, $) {
    ...
    const Z = (re, ...ie) => __awaiter(this, void 0, void 0, function* () {
        if (K = re ?? null, Y == null || Y.abort(), Y = createAbortController(re), Y.signal.aborted)
        ...
        const le = yield se;
        if (V !== se && le !== W)
            throw yield $(le), new TonConnectError("Resource creation was aborted by a new resource creation");
        return W = le, W
    });
    return {
        create: Z,
        ...
        recreate: re => __awaiter(this, void 0, void 0, function* () {
            const ie = W,
                ...
                le = U,
                ue = K;
            if (yield delay(re), ie === W && se === V && le === U && ue === K)
                return yield Z(K, ...le ?? []);
...
class BridgeGateway {
    ...
    send($, W, U, V) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield callForSuccess(X => __awaiter(this, void 0, void 0, function* () {
                ...
                if (!oe.ok)
                    throw new TonConnectError(`Bridge send failed, status ${oe.status}`)
            }), {
    ...
    errorsHandler($, W) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.isClosed)
                return $.close(), logDebug$1(`Bridge reconnecting, ${this.defaultReconnectDelay}ms delay`), yield this.eventSource.recreate(this.defaultReconnectDelay);
            throw new TonConnectError("Bridge error, unknown state")
        })
    }
    messagesHandler($) {
        return __awaiter(this, void 0, void 0, function* () {
            if ($.data === this.heartbeatMessage || (yield this.bridgeGatewayStorage.storeLastEventId($.lastEventId), this.isClosed))
                return;
            let W;
            try {
                W = JSON.parse($.data)
    ...
    storeLastWalletEventId($) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (W && W.type === "http" && !isPendingConnectionHttp(W))
                return W.lastWalletEventId = $, this.storeConnection(W)
        })
    }
...
class BridgeProvider {
    ...
    pendingGatewaysListener($, W, U) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            }), this.gateway && (logDebug$1("Gateway is already opened, closing previous gateway"), yield this.gateway.close()), this.session.bridgeUrl = W, this.gateway = $, this.gateway.setErrorsListener(this.gatewayErrorsListener.bind(this)), this.gateway.setListener(this.gatewayListener.bind(this)), this.gatewayListener(U)
        })
    }
    gatewayListener($) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            W.event === "connect" && (yield this.updateSession(W, $.from)),
                W.event === "disconnect" && (logDebug$1("Removing bridge and session: received disconnect event"), yield this.removeBridgeAndSession()),
                U.forEach(V => V(W))
        })
    }
    ...
    openGateways($, W) {
        return __awaiter(this, void 0, void 0, function* () {
            if (Array.isArray(this.walletConnectionSource)) {
                ...
                return this.gateway && (logDebug$1("Gateway is already opened, closing previous gateway"), yield this.gateway.close()), this.gateway = new BridgeGateway(this.storage, this.walletConnectionSource.bridgeUrl, $.sessionId, this.gatewayListener.bind(this), this.gatewayErrorsListener.bind(this)), yield this.gateway.registerSession({
                    openingDeadlineMS: W == null ? void 0 : W.openingDeadlineMS,
                    signal: W == null ? void 0 : W.signal
                })
        })
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                logDebug$1("Injected Provider restoring connection response", $),
                    $.event === "connect" ? (this.makeSubscriptions(), this.listeners.forEach(W => W($))) : yield this.connectionStorage.removeConnection()
            } catch ($) {
                yield this.connectionStorage.removeConnection(),
                    console.error($)
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                logDebug$1("Injected Provider connect response:", U),
                    U.event === "connect" && (yield this.updateSession(), this.makeSubscriptions()),
...
class WalletsListManager {
    ...
    fetchWalletsList() {
        return __awaiter(this, void 0, void 0, function* () {
            let $ = [];
            try {
                if ($ = yield(yield fetch(this.walletsListSource)).json(), !Array.isArray($))
    ...
    isCorrectWalletConfigDTO($) {
        ...
        if (!W || !V || !K || !Y || !U || !$.platforms || !Array.isArray($.platforms) || !$.platforms.length || !("bridge" in $) || !Array.isArray($.bridge) || !$.bridge.length)
            return !1;
        const Z = $.bridge;
        if (Z.some(oe => !oe || typeof oe != "object" || !("type" in oe)))
            return !1;
...
class TonConnect {
    ...
    connect($, W) {
        var U,
            V;
        const K = {};
        if (typeof W == "object" && "tonProof" in W && (K.request = W), typeof W == "object" && ("openingDeadlineMS" in W || "signal" in W || "request" in W) && (K.request = W == null ? void 0 : W.request, K.openingDeadlineMS = W == null ? void 0 : W.openingDeadlineMS, K.signal = W == null ? void 0 : W.signal), this.connected)
            throw new WalletAlreadyConnectedError;
        const Y = createAbortController(K == null ? void 0 : K.signal);
        if ((U = this.abortController) === null || U === void 0 || U.abort(), this.abortController = Y, Y.signal.aborted)
    ...
    sendTransaction($, W) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (sendTransactionParser.isError(X))
                return this.tracker.trackTransactionSigningFailed(this.wallet, $, X.error.message, X.error.code), sendTransactionParser.parseAndThrowError(X);
    ...
    disconnect($) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.abortController = U, U.signal.aborted)
    ...
    onWalletConnectError($) {
        ...
        if (this.statusChangeErrorSubscriptions.forEach(U => U(W)), logDebug$1(W), this.tracker.trackConnectionError($.message, $.code), W instanceof ManifestNotFoundError || W instanceof ManifestContentErrorError)
            throw logError$1(W), W
    }
...
(function (R, $) {
    (function (W, U) {
        var V = "1.0.38",
            ...
            Mt = function (ft, bt) {
                if (typeof ft === oe)
                    return ft = ft.replace(/^\s\s*/, K), typeof bt === J ? ft : ft.substring(0, ye)
            },
            Rt = function (ft, bt) {
            ...
            qt = function (ft, bt) {
                if (typeof ft === X && (bt = ft, ft = U), !(this instanceof qt))
        ...
        qt.VERSION = V,
            qt.BROWSER = Ie([se, pe, re]),
            qt.CPU = Ie([Re]),
            qt.DEVICE = Ie([ie, ue, le, Se, Ee, we, Be, Pe, be]),
            qt.ENGINE = qt.OS = Ie([se, pe]),
...
function createResource(R, $, W) {
    ...
    let Y = null,
        ...
        J = null,
        X = !1,
        oe = "initialValue" in K,
        re = typeof U == "function" && createMemo(U);
    const ie = new Set,
        [se, le] = (K.storage || createSignal)(K.initialValue),
        [ue, pe] = createSignal(void 0),
        [Re, Se] = createSignal(void 0, {
            equals: !1
        }),
        [Ee, Be] = createSignal(oe ? "ready" : "unresolved");
    ...
    function we(de, xe, he, ce) {
        return Y === de && (Y = null, oe = !0, (de === Z || xe === Z) && K.onHydrated && queueMicrotask(() => K.onHydrated(ce, {
            value: xe
        })), Z = NO_INIT, Pe(xe, he)), xe
    }
    function Pe(de, xe) {
        runUpdates(() => {
            xe === void 0 && le(() => de),
                Be(xe !== void 0 ? "errored" : "ready"),
                pe(xe);
    ...
    function be() {
        ...
        return Listener && !Listener.user && de && createComputed(() => {
            Re(),
                Y && (de.resolved || ie.has(de) || (de.increment(), ie.add(de)))
        }), xe
    }
    function ye(de = !0) {
        if (de !== !1 && X)
    ...
    }), re ? createComputed(() => ye(!1)) : ye(!1), [be, {
        refetch: ye,
        mutate: le
    }]
}
...
function readSignal() {
    ...
    if (Listener) {
        ...
        Listener.sources ? (Listener.sources.push(this), Listener.sourceSlots.push($)) : (Listener.sources = [this], Listener.sourceSlots = [$]),
            this.observers ? (this.observers.push(Listener), this.observerSlots.push(Listener.sources.length - 1)) : (this.observers = [Listener], this.observerSlots = [Listener.sources.length - 1])
    }
    return this.value
}
    ...
    return (!R.comparator || !R.comparator(U, $)) && (R.value = $, R.observers && R.observers.length && runUpdates(() => {
        for (let V = 0; V < R.observers.length; V += 1) {
            ...
            Y && Transition$1.disposed.has(K),
                (Y && !K.tState || !Y && !K.state) && (K.pure ? Updates.push(K) : Effects.push(K), K.observers && markDownstream(K)),
                Y || (K.state = STALE)
        }
...
function runComputation(R, $, W) {
    ...
    try {
        ...
        R.pure && (R.state = STALE, R.owned && R.owned.forEach(cleanNode), R.owned = null),
            handleError(V)
    }
...
function runTop(R) {
    ...
    const W = [R];
    for (;
        (R = R.owner) && (!R.updatedAt || R.updatedAt < ExecCount);)
        (R.state || $) && W.push(R);
    for (let U = W.length - 1; U >= 0; U--)
        if (R = W[U], R.state === STALE || $)
            updateComputation(R);
...
function completeUpdates(R) {
    if (Updates && (runQueue(Updates), Updates = null), R)
        return;
    const $ = Effects;
    Effects = null,
...
function runUserEffects(R) {
    ...
    for (sharedConfig.context && setHydrateContext(), $ = 0; $ < W; $++)
        runTop(R[$])
}
    ...
    return onCleanup(() => dispose(K)), () => {
        ...
        return J[$TRACK], untrack(() => {
            let ie = J.length,
                ...
                we;
            if (ie === 0)
                Y !== 0 && (dispose(K), K = [], U = [], V = [], Y = 0, Z && (Z = [])),
                W.fallback && (U = [FALLBACK], V[0] = createRoot(Pe => (K[0] = Pe, W.fallback())), Y = 1);
            else if (Y === 0) {
                for (V = new Array(ie), oe = 0; oe < ie; oe++)
                    U[oe] = J[oe],
                    V[oe] = createRoot(re);
                Y = ie
            } else {
                ...
                ;
                for (Ee = Y - 1, Be = ie - 1; Ee >= Se && Be >= Se && U[Ee] === J[Be]; Ee--, Be--)
                    ue[Be] = V[Ee],
                    pe[Be] = K[Ee],
                    Z && (Re[Be] = Z[Ee]);
                for (se = new Map, le = new Array(Be + 1), oe = Be; oe >= Se; oe--)
                    we = J[oe],
                    X = se.get(we),
                    le[oe] = X === void 0 ? -1 : X,
                    se.set(we, oe);
                for (X = Se; X <= Ee; X++)
                    we = U[X],
                    oe = se.get(we),
                    oe !== void 0 && oe !== -1 ? (ue[oe] = V[X], pe[oe] = K[X], Z && (Re[oe] = Z[X]), oe = le[oe], se.set(we, oe)) : K[X]();
                for (oe = Se; oe < ie; oe++)
                    oe in ue ? (V[oe] = ue[oe], K[oe] = pe[oe], Z && (Z[oe] = Re[oe], Z[oe](oe))) : V[oe] = createRoot(re);
                V = V.slice(0, Y = ie),
                    U = J.slice(0)
            }
            return V
...
function mergeProps(...R) {
    ...
    for (let U = 0; U < R.length; U++) {
        const V = R[U];
        $ = $ || !!V && $PROXY in V,
            R[U] = typeof V == "function" ? ($ = !0, createMemo(V)) : V
    }
    if ($)
        return new Proxy({
            get(U) {
...
function Switch(R) {
    ...
    return createMemo(() => {
        ...
        if (Y < 0)
            return R.fallback;
        const X = J.children,
            oe = typeof X == "function" && X.length > 0;
            ...
            if (oe != null)
                if (Z < oe && oe < K) {
                    let re = Y,
                        ie = 1,
                        se;
                    for (; ++re < V && re < K && !((se = X.get($[re])) == null || se !== oe + ie);)
                        ie++;
                    if (ie > oe - Z) {
                        const le = $[Y];
                        for (; Z < oe;)
...
function addEventListener(R, $, W, U) {
    if (U)
        Array.isArray(W) ? (R[`$$${$}`] = W[0], R[`$$${$}Data`] = W[1]) : R[`$$${$}`] = W;
...
function insert(R, $, W, U) {
    if (W !== void 0 && !U && (U = []), typeof $ != "function")
...
function eventHandler(R) {
    ...
    for (R.target !== W && Object.defineProperty(R, "target", {
        ...
        if (U && !W.disabled) {
            const V = W[`${$}Data`];
            if (V !== void 0 ? U.call(W, V, R) : U.call(W, R), R.cancelBubble)
                return
        }
    ...
    if (R = Y && W[0] && W[0].parentNode || R, K === "string" || K === "number") {
        ...
        if (Array.isArray($)) {
            ...
            if (normalizeIncomingArray(Z, $, W, V))
                return createRenderEffect(() => W = insertExpression(R, Z, W, U, !0)), () => W;
            if (sharedConfig.context) {
                if (!Z.length)
                    return W;
            ...
            if (Z.length === 0) {
                if (W = cleanChildren(R, W, U), Y)
                    return W
            } else
                J ? W.length === 0 ? appendNodes(R, Z, U) : reconcileArrays(R, W, Z) : (W && cleanChildren(R), appendNodes(R, Z));
            W = Z
        ...
        if (!c[Y]) {
            let J = K !== R ? R : (X => {
                let oe,
                    re,
                    ie = [{}];
                for (; oe = l.exec(X.replace(a, ""));)
                    oe[4] ? ie.shift() : oe[3] ? (re = oe[3].replace(n, " ").trim(), ie.unshift(ie[0][re] = ie[0][re] || {})) : ie[0][oe[1]] = oe[2].replace(n, " ").trim();
                return ie[0]
            })(R);
            c[Y] = o(V ? {
                ["@keyframes " + Y]: J
    ...
    return (...W) => {
        const U = V => {
            const K = useContext(ThemeContext),
                ...
                re = J.as || R;
            let ie;
            return typeof re == "function" ? ie = re(oe) : $.g == 1 ? (ie = document.createElement(re), spread(ie, oe)) : ie = Dynamic(mergeProps({
                component: re
            }, oe)), ie
        };
...
const globalStylesTag = "tc-root",
    ...
    body.${
        usingMouseClass} ${globalStylesTag} *:focus {
        outline: none;
    }
`
        ;
...
function unwrap(R, $ = new Set) {
    ...
    if (Array.isArray(R)) {
        ...
        for (let J = 0, X = Y.length; J < X; J++)
            K = Y[J],
            !Z[K].get && (V = R[K], (U = unwrap(V, $)) !== V && (R[K] = U))
    }
    return R
}
...
function updatePath(R, $, W = []) {
    ...
    if ($.length > 1) {
        ...
        if (Array.isArray(U)) {
            ...
            for (let re = J; re <= X; re += oe)
                updatePath(R, [re].concat($), W);
            return
        } else if ($.length > 1) {
...
function setTheme(R, $) {
    $ && (themeCustomColors[THEME.DARK] = mergeOptions($[THEME.DARK], themeCustomColors[THEME.DARK]), themeCustomColors[THEME.LIGHT] = mergeOptions($[THEME.LIGHT], themeCustomColors[THEME.LIGHT])),
        setThemeState({
            theme: R,
...
function versionCompare(R, $) {
    typeof R != "string" && (R = ""),
        typeof $ != "string" && ($ = "");
    let W = R.replace(/^\s+|\s+$/g, "").split("."),
        U = $.replace(/^\s+|\s+$/g, "").split("."),
        V,
        K,
        Y,
        Z;
    for (V = Math.max(W.length, U.length), K = 0; K < V; K++)
        if (Y = parseInt(W[K]) || 0, Z = parseInt(U[K]) || 0, Y !== Z)
            return Y > Z ? 1 : -1;
    return 0
}
...
const mediaTouch = "@media (hover: none)",
    ...
    padding: ${
    R => R.appearance === "flat" ? "0" : "9px 16px"};
    ...
    mediaNotTouch} {
        &:hover {
            transform: ${
    R => R.disabled ? "unset" : `scale(${1 + scaleValues[R.scale]})`};
        }
    }
    &:active {
        transform: ${
    ...
    mediaTouch} {
        &:active {
            transform: ${
    R => R.disabled ? "unset" : `scale(${1 - scaleValues[R.scale] * 2})`};
        }
    }
`
;
...
const Transition = R => {
    ...
    function ue(Re, Se) {
        if (!W || R.appear) {
            ...
            const Be = le().enterClass.split(" "),
                we = le().enterActiveClass.split(" "),
            ...
            J && J(Re),
                ...
                nextFrame(() => {
                    Re.classList.remove(...Be),
                        Re.classList.add(...Pe),
                        X && X(Re, () => Ee()),
                        (!X || X.length < 2) && (Re.addEventListener("transitionend", Ee), Re.addEventListener("animationend", Ee))
                })
        }
        Se && !R.mode ? Y(Re) : V(Re)
    }
    function pe(Re, Se) {
        const Ee = le().exitClass.split(" "),
            Be = le().exitActiveClass.split(" "),
            we = le().exitToClass.split(" ");
        if (!Se.parentNode)
            return Pe();
        re && re(Se),
            Se.classList.add(...Ee),
            Se.classList.add(...Be),
            nextFrame(() => {
                Se.classList.remove(...Ee),
                    Se.classList.add(...we)
            }),
            ie && ie(Se, () => Pe()),
            (!ie || ie.length < 2) && (Se.addEventListener("transitionend", Pe), Se.addEventListener("animationend", Pe));
        function Pe(be) {
...
const TransitionGroup = R => {
    ...
    return createComputed(() => {
        const se = $(),
            ...
            ue = new Set(se),
            pe = new Set(re),
            Re = W().enterClass.split(" "),
            Se = W().enterActiveClass.split(" "),
            Ee = W().enterToClass.split(" "),
            Be = W().exitClass.split(" "),
            we = W().exitActiveClass.split(" "),
            Pe = W().exitToClass.split(" ");
        for (let be = 0; be < se.length; be++) {
            ...
            if (!ie && !pe.has(ye)) {
                ...
                U && U(ye),
                    ...
                    ye.classList.add(...Se),
                    nextFrame(() => {
                        ye.classList.remove(...Re),
                            ye.classList.add(...Ee),
                            V && V(ye, () => de()),
                            (!V || V.length < 2) && (ye.addEventListener("transitionend", de), ye.addEventListener("animationend", de))
                    })
            }
        }
        for (let be = 0; be < re.length; be++) {
            ...
            if (!ue.has(ye) && ye.parentNode) {
                ...
                le.splice(be, 0, ye),
                    ...
                    Z && Z(ye, () => de()),
                    (!Z || Z.length < 2) && (ye.addEventListener("transitionend", de), ye.addEventListener("animationend", de))
            }
        }
        re = le,
            oe(le)
        ...
        return le.forEach(ue => {
            ...
            if (Ee || Be) {
                pe.moved = !0;
                const we = ue.style;
                we.transform = `translate(${Ee}px,${Be}px)`,
                    we.transitionDuration = "0s"
            }
            ...
            if (pe.moved) {
                ...
                pe.moved = !1;
                const Se = ue.style,
                    Ee = W().moveClass.split(" ");
                ue.classList.add(...Ee),
                    Se.transform = Se.transitionDuration = "",
                    ue.addEventListener("transitionend", Re)
            }
        }), se)
    }, new Map), X
};
...
const ROUTE_STATE_KEY = "androidBackHandler",
    ...
    border-radius: 50%;
    background-color: ${
    R => R.theme.colors.background.tint};
    border: none;
    cursor: pointer;
    transition: transform 0.125s ease-in-out;
    ${
...
`
    ...
    background-color: ${
    R => R.theme.colors.background.primary};
...
const _tmpl$$t = template$1("<div></div>"),
    ...
    padding: 4px;
    border-radius: ${
    R => wrapperBorderRadius[R.theme.borderRadius]};
    background-color: ${
    R => R.theme.colors.background.secondary};
`,
    ...
    width: calc(50% - 4px);
    border-radius: ${
    R => sliderBorderRadius[R.theme.borderRadius]};
    background-color: ${R => R.theme.colors.background.segment};
    transform: ${
    R => R.right ? "translateX(100%)" : "translateX(0)"};
...
`
    ...
    z-index: 1;
    cursor: ${
    R => R.isActive ? "default" : "pointer"};
    transition: transform 0.13s ease-in-out;
    &:hover {
        transform: ${
    R => R.isActive ? "none" : "scale(1.025)"};
    }
    > * {
        ${
...
`
    ...
    position: relative;
    background-color: ${
    R => R.theme.colors.background.qr};
...
`
    ...
    path {
        fill: ${
    R => R.theme.colors.constant.black};
    }
`
    ,
...
CopiedBoxStyled = styled.div `
    ...
    background-color: ${
    R => R.theme.colors.background.segment};
`;
var qrcode$1 = {
    exports: {}
};
        ...
        var U = function (we, Pe) {
            var be = 236,
                ...
                tt = function ($e, Te) {
                    ce = de * 4 + 17,
                        ...
                        Vt($e, Te),
                        de >= 7 && Gt($e),
                        Oe == null && (Oe = gt(de, xe, We)),
                        Bt(Oe, Te)
                },
                at = function ($e, Te) {
                    for (var Ce = -1; Ce <= 7; Ce += 1)
                        if (!($e + Ce <= -1 || ce <= $e + Ce))
                            for (var Le = -1; Le <= 7; Le += 1)
                                Te + Le <= -1 || ce <= Te + Le || (0 <= Ce && Ce <= 6 && (Le == 0 || Le == 6) || 0 <= Le && Le <= 6 && (Ce == 0 || Ce == 6) || 2 <= Ce && Ce <= 4 && 2 <= Le && Le <= 4 ? he[$e + Ce][Te + Le] = !0 : he[$e + Ce][Te + Le] = !1)
                },
                Ct = function () {
                ...
                Pt = function () {
                    for (var $e = Z.getPatternPosition(de), Te = 0; Te < $e.length; Te += 1)
                        for (var Ce = 0; Ce < $e.length; Ce += 1) {
                            var Le = $e[Te],
                                Ie = $e[Ce];
                            if (he[Le][Ie] == null)
                                for (var je = -2; je <= 2; je += 1)
                                    for (var Xe = -2; Xe <= 2; Xe += 1)
                                        je == -2 || je == 2 || Xe == -2 || Xe == 2 || je == 0 && Xe == 0 ? he[Le + je][Ie + Xe] = !0 : he[Le + je][Ie + Xe] = !1
                        }
                },
                Gt = function ($e) {
                ...
                Bt = function ($e, Te) {
                    for (var Ce = -1, Le = ce - 1, Ie = 7, je = 0, Xe = Z.getMaskFunction(Te), et = ce - 1; et > 0; et -= 2)
                        for (et == 6 && (et -= 1);;) {
                ...
                Ht = function ($e, Te) {
                    for (var Ce = 0, Le = 0, Ie = 0, je = new Array(Te.length), Xe = new Array(Te.length), et = 0; et < Te.length; et += 1) {
                        ...
                        for (var rt = 0; rt < je[et].length; rt += 1)
                            je[et][rt] = 255 & $e.getBuffer()[rt + Ce];
                        Ce += Mt;
                    ...
                    for (var Jt = 0, rt = 0; rt < Te.length; rt += 1)
                        Jt += Te[rt].totalCount;
                    for (var Xt = new Array(Jt), ft = 0, rt = 0; rt < Le; rt += 1)
                        for (var et = 0; et < Te.length; et += 1)
                            rt < je[et].length && (Xt[ft] = je[et][rt], ft += 1);
                    for (var rt = 0; rt < Ie; rt += 1)
                        for (var et = 0; et < Te.length; et += 1)
                            rt < Xe[et].length && (Xt[ft] = Xe[et][rt], ft += 1);
                    return Xt
                },
                gt = function ($e, Te, Ce) {
                    for (var Le = oe.getRSBlocks($e, Te), Ie = re(), je = 0; je < Ce.length; je += 1) {
                        var Xe = Ce[je];
                        Ie.put(Xe.getMode(), 4),
                            Ie.put(Xe.getLength(), Z.getLengthInBits(Xe.getMode(), $e)),
                            Xe.write(Ie)
                    }
                    for (var et = 0, je = 0; je < Le.length; je += 1)
                        et += Le[je].dataCount;
                    if (Ie.getLengthInBits() > et * 8)
                        throw "code length overflow. (" + Ie.getLengthInBits() + ">" + et * 8 + ")";
                    for (Ie.getLengthInBits() + 4 <= et * 8 && Ie.put(0, 4); Ie.getLengthInBits() % 8 != 0;)
                        Ie.putBit(!1);
                    for (; !(Ie.getLengthInBits() >= et * 8 || (Ie.put(be, 8), Ie.getLengthInBits() >= et * 8));)
                        Ie.put(ye, 8);
                    return Ht(Ie, Le)
                };
            He.addData = function ($e, Te) {
                    ...
                    if (de < 1) {
                        for (var $e = 1; $e < 40; $e++) {
                            for (var Te = oe.getRSBlocks($e, xe), Ce = re(), Le = 0; Le < We.length; Le++) {
                                var Ie = We[Le];
                                Ce.put(Ie.getMode(), 4),
                                    Ce.put(Ie.getLength(), Z.getLengthInBits(Ie.getMode(), $e)),
                                    Ie.write(Ce)
                            }
                            for (var je = 0, Le = 0; Le < Te.length; Le++)
                                je += Te[Le].dataCount;
                            if (Ce.getLengthInBits() <= je * 8)
                                break
                        }
                        de = $e
                    }
                ...
                He.createTableTag = function ($e, Te) {
                    ...
                    var Ce = "";
                    Ce += '<table style="',
                        Ce += " border-width: 0px; border-style: none;",
                        Ce += " border-collapse: collapse;",
                        Ce += " padding: 0px; margin: " + Te + "px;",
                        Ce += '">',
                        Ce += "<tbody>";
                    for (var Le = 0; Le < He.getModuleCount(); Le += 1) {
                        ...
                        for (var Ie = 0; Ie < He.getModuleCount(); Ie += 1)
                            ...
                            Ce += " border-width: 0px; border-style: none;",
                            Ce += " border-collapse: collapse;",
                            Ce += " padding: 0px; margin: 0px;",
                            Ce += " width: " + $e + "px;",
                            Ce += " height: " + $e + "px;",
                            Ce += " background-color: ",
                            Ce += He.isDark(Le, Ie) ? "#000000" : "#ffffff",
                            Ce += ";",
                            Ce += '"/>';
                        Ce += "</tr>"
                    }
                ...
                He.createSvgTag = function ($e, Te, Ce, Le) {
                    var Ie = {};
                    typeof arguments[0] == "object" && (Ie = arguments[0], $e = Ie.cellSize, Te = Ie.margin, Ce = Ie.alt, Le = Ie.title),
                        $e = $e || 2,
                        Te = typeof Te > "u" ? $e * 4 : Te,
                        Ce = typeof Ce == "string" ? {
                            text: Ce
                        } : Ce || {},
                        Ce.text = Ce.text || null,
                        Ce.id = Ce.text ? Ce.id || "qrcode-description" : null,
                        Le = typeof Le == "string" ? {
                            text: Le
                        } : Le || {},
                        Le.text = Le.text || null,
                        Le.id = Le.text ? Le.id || "qrcode-title" : null;
                    var je = He.getModuleCount() * $e + Te * 2,
                        Xe,
                        et,
                        Mt,
                        Rt,
                        rt = "",
                        Wt;
                    for (Wt = "l" + $e + ",0 0," + $e + " -" + $e + ",0 0,-" + $e + "z ", rt += '<svg version="1.1" xmlns="http://www.w3.org/2000/svg"', rt += Ie.scalable ? "" : ' width="' + je + 'px" height="' + je + 'px"', rt += ' viewBox="0 0 ' + je + " " + je + '" ', rt += ' preserveAspectRatio="xMinYMin meet"', rt += Le.text || Ce.text ? ' role="img" aria-labelledby="' + Nt([Le.id, Ce.id].join(" ").trim()) + '"' : "", rt += ">", rt += Le.text ? '<title id="' + Nt(Le.id) + '">' + Nt(Le.text) + "</title>" : "", rt += Ce.text ? '<description id="' + Nt(Ce.id) + '">' + Nt(Ce.text) + "</description>" : "", rt += '<rect width="100%" height="100%" fill="white" cx="0" cy="0"/>', rt += '<path d="', Mt = 0; Mt < He.getModuleCount(); Mt += 1)
                        for (Rt = Mt * $e + Te, Xe = 0; Xe < He.getModuleCount(); Xe += 1)
                            He.isDark(Mt, Xe) && (et = Xe * $e + Te, rt += "M" + et + "," + Rt + Wt);
                    return rt += '" stroke="transparent" fill="black"/>', rt += "</svg>", rt
                },
                He.createDataURL = function ($e, Te) {
                    $e = $e || 2,
                        Te = typeof Te > "u" ? $e * 4 : Te;
                    var Ce = He.getModuleCount() * $e + Te * 2,
                        Le = Te,
                        Ie = Ce - Te;
                    return Be(Ce, Ce, function (je, Xe) {
                        if (Le <= je && je < Ie && Le <= Xe && Xe < Ie) {
                            var et = Math.floor((je - Le) / $e),
                                Mt = Math.floor((Xe - Le) / $e);
                ...
                He.createImgTag = function ($e, Te, Ce) {
                    $e = $e || 2,
                        Te = typeof Te > "u" ? $e * 4 : Te;
                    var Le = He.getModuleCount() * $e + Te * 2,
                        Ie = "";
            ...
            var Nt = function ($e) {
                ...
                un = function ($e) {
                    var Te = 1;
                    $e = typeof $e > "u" ? Te * 2 : $e;
                    var Ce = He.getModuleCount() * Te + $e * 2,
                        Le = $e,
                        Ie = Ce - $e,
                        je,
                        Xe,
                        ...
                        jt = "";
                    for (je = 0; je < Ce; je += 2) {
                        for (et = Math.floor((je - Le) / Te), Mt = Math.floor((je + 1 - Le) / Te), Xe = 0; Xe < Ce; Xe += 1)
                            Rt = "█",
                            Le <= Xe && Xe < Ie && Le <= je && je < Ie && He.isDark(et, Math.floor((Xe - Le) / Te)) && (Rt = " "),
                            Le <= Xe && Xe < Ie && Le <= je + 1 && je + 1 < Ie && He.isDark(Mt, Math.floor((Xe - Le) / Te)) ? Rt += " " : Rt += "█",
                            jt += $e < 1 && je + 1 >= Ie ? Wt[Rt] : rt[Rt];
                        jt += `
`
                    }
            ...
            return He.createASCII = function ($e, Te) {
                ...
                var Ce = He.getModuleCount() * $e + Te * 2,
                    ...
                    jt = "";
                for (je = 0; je < Ce; je += 1) {
                    for (et = Math.floor((je - Le) / $e), jt = "", Xe = 0; Xe < Ce; Xe += 1)
                        Mt = 1,
                        Le <= Xe && Xe < Ie && Le <= je && je < Ie && He.isDark(et, Math.floor((Xe - Le) / $e)) && (Mt = 0),
                        jt += Mt ? Rt : rt;
                    for (et = 0; et < $e; et += 1)
                        Wt += jt + `
`
                ...
                Te = Te || 2;
                for (var Ce = He.getModuleCount(), Le = 0; Le < Ce; Le++)
                    for (var Ie = 0; Ie < Ce; Ie++)
                        $e.fillStyle = He.isDark(Le, Ie) ? "black" : "white",
                        $e.fillRect(Le * Te, Ie * Te, Te, Te)
            }, He
        };
        U.stringToBytesFuncs = {
            ...
            U.createStringToBytes = function (we, Pe) {
                var be = function () {
                        for (var de = Se(we), xe = function () {
                            ...
                            var We = xe(),
                                He = xe(),
                                tt = xe(),
                                at = String.fromCharCode(Oe << 8 | We),
                                Ct = He << 8 | tt;
                            ce[at] = Ct,
                                he += 1
                        }
        ...
        var V = {
            ...
            Z = function () {
                ...
                return de.getBCHTypeInfo = function (he) {
                    for (var ce = he << 10; xe(ce) - xe(Pe) >= 0;)
                        ce ^= Pe << xe(ce) - xe(Pe);
                    return (he << 10 | ce) ^ ye
                }, de.getBCHTypeNumber = function (he) {
                    for (var ce = he << 12; xe(ce) - xe(be) >= 0;)
                        ce ^= be << xe(ce) - xe(be);
                    return he << 12 | ce
                    ...
                    for (var ce = he.getModuleCount(), Oe = 0, We = 0; We < ce; We += 1)
                        for (var He = 0; He < ce; He += 1) {
                            for (var tt = 0, at = he.isDark(We, He), Ct = -1; Ct <= 1; Ct += 1)
                                if (!(We + Ct < 0 || ce <= We + Ct))
                                    for (var At = -1; At <= 1; At += 1)
                                        He + At < 0 || ce <= He + At || Ct == 0 && At == 0 || at == he.isDark(We + Ct, He + At) && (tt += 1);
                            tt > 5 && (Oe += 3 + tt - 5)
                        }
                    for (var We = 0; We < ce - 1; We += 1)
                        for (var He = 0; He < ce - 1; He += 1) {
                            var Pt = 0;
                            he.isDark(We, He) && (Pt += 1),
                                he.isDark(We + 1, He) && (Pt += 1),
                                he.isDark(We, He + 1) && (Pt += 1),
                                he.isDark(We + 1, He + 1) && (Pt += 1),
                                (Pt == 0 || Pt == 4) && (Oe += 3)
                        }
                    for (var We = 0; We < ce; We += 1)
                        for (var He = 0; He < ce - 6; He += 1)
                            he.isDark(We, He) && !he.isDark(We, He + 1) && he.isDark(We, He + 2) && he.isDark(We, He + 3) && he.isDark(We, He + 4) && !he.isDark(We, He + 5) && he.isDark(We, He + 6) && (Oe += 40);
                    for (var He = 0; He < ce; He += 1)
                        for (var We = 0; We < ce - 6; We += 1)
                            he.isDark(We, He) && !he.isDark(We + 1, He) && he.isDark(We + 2, He) && he.isDark(We + 3, He) && he.isDark(We + 4, He) && !he.isDark(We + 5, He) && he.isDark(We + 6, He) && (Oe += 40);
                    for (var Gt = 0, He = 0; He < ce; He += 1)
                        for (var We = 0; We < ce; We += 1)
                            he.isDark(We, He) && (Gt += 1);
                    var Vt = Math.abs(100 * Gt / ce / ce - 50) / 5;
                    return Oe += Vt * 10, Oe
                }, de
            }(),
            J = function () {
                for (var we = new Array(256), Pe = new Array(256), be = 0; be < 8; be += 1)
                    we[be] = 1 << be;
                for (var be = 8; be < 256; be += 1)
                    we[be] = we[be - 4] ^ we[be - 5] ^ we[be - 6] ^ we[be - 8];
                for (var be = 0; be < 255; be += 1)
                    Pe[we[be]] = be;
                var ye = {};
        ...
        function X(we, Pe) {
            if (typeof we.length > "u")
                throw we.length + "/" + Pe;
            var be = function () {
                    for (var de = 0; de < we.length && we[de] == 0;)
                        de += 1;
                    for (var xe = new Array(we.length - de + Pe), he = 0; he < we.length - de; he += 1)
                        xe[he] = we[he + de];
                    return xe
                }(),
                ye = {};
            return ye.getAt = function (de) {
                ...
                for (var xe = new Array(ye.getLength() + de.getLength() - 1), he = 0; he < ye.getLength(); he += 1)
                    for (var ce = 0; ce < de.getLength(); ce += 1)
                        xe[he + ce] ^= J.gexp(J.glog(ye.getAt(he)) + J.glog(de.getAt(ce)));
                return X(xe, 0)
            }, ye.mod = function (de) {
                if (ye.getLength() - de.getLength() < 0)
                    return ye;
                for (var xe = J.glog(ye.getAt(0)) - J.glog(de.getAt(0)), he = new Array(ye.getLength()), ce = 0; ce < ye.getLength(); ce += 1)
                    he[ce] = ye.getAt(ce);
                for (var ce = 0; ce < de.getLength(); ce += 1)
                    he[ce] ^= J.gexp(J.glog(de.getAt(ce)) + xe);
        ...
        var oe = function () {
                ...
                return be.getRSBlocks = function (de, xe) {
                    var he = ye(de, xe);
                    if (typeof he > "u")
                        throw "bad rs block @ typeNumber:" + de + "/errorCorrectionLevel:" + xe;
                    for (var ce = he.length / 3, Oe = [], We = 0; We < ce; We += 1)
                        for (var He = he[We * 3 + 0], tt = he[We * 3 + 1], at = he[We * 3 + 2], Ct = 0; Ct < He; Ct += 1)
                            Oe.push(Pe(tt, at));
                    return Oe
                }, be
            }(),
            re = function () {
                ...
                return be.getBuffer = function () {
                    ...
                    for (var xe = 0; xe < de; xe += 1)
                        be.putBit((ye >>> de - xe - 1 & 1) == 1)
                }, be.getLengthInBits = function () {
                    return Pe
                }, be.putBit = function (ye) {
                    var de = Math.floor(Pe / 8);
                    we.length <= de && we.push(0),
                        ye && (we[de] |= 128 >>> Pe % 8),
                        Pe += 1
                }, be
            },
            ie = function (we) {
                var Pe = V.MODE_NUMBER,
                    be = we,
                    ye = {};
                ye.getMode = function () {
                        return Pe
                    ...
                    ye.write = function (he) {
                        for (var ce = be, Oe = 0; Oe + 2 < ce.length;)
            ...
            se = function (we) {
                ...
                ye.getMode = function () {
                    ...
                    ye.write = function (xe) {
                        for (var he = be, ce = 0; ce + 1 < he.length;)
                            xe.put(de(he.charAt(ce)) * 45 + de(he.charAt(ce + 1)), 11),
                            ce += 2;
                        ce < he.length && xe.put(de(he.charAt(ce)), 6)
                    };
                var de = function (xe) {
                    if ("0" <= xe && xe <= "9")
                        return xe.charCodeAt(0) - 48;
                    if ("A" <= xe && xe <= "Z")
                        return xe.charCodeAt(0) - 65 + 10;
                    switch (xe) {
                    case " ":
                        return 36;
                    case "$":
            ...
            le = function (we) {
                var Pe = V.MODE_8BIT_BYTE,
                    be = U.stringToBytes(we),
                    ye = {};
                return ye.getMode = function () {
                    ...
                    for (var xe = 0; xe < be.length; xe += 1)
                        de.put(be[xe], 8)
                }, ye
            },
            ue = function (we) {
                var Pe = V.MODE_KANJI,
                    be = U.stringToBytesFuncs.SJIS;
                if (!be)
            ...
            Re = function () {
                ...
                return de.writeByte = function (ce) {
                    for (we = we << 8 | ce & 255, Pe += 8, be += 1; Pe >= 6;)
                        xe(we >>> Pe - 6),
                        Pe -= 6
                }, de.flush = function () {
                    if (Pe > 0 && (xe(we << 6 - Pe), we = 0, Pe = 0), be % 3 != 0)
                        for (var ce = 3 - be % 3, Oe = 0; Oe < ce; Oe += 1)
                            ye += "="
                ...
                xe.setPixel = function (We, He, tt) {
                    ...
                    xe.write = function (We) {
                        ...
                        for (var at = 0; tt.length - at > 255;)
                            We.writeByte(255),
                            We.writeBytes(tt, at, 255),
                            at += 255;
                        We.writeByte(tt.length - at),
                            We.writeBytes(tt, at, tt.length - at),
                            We.writeByte(0),
                            We.writeString(";")
                    };
                var he = function (We) {
                    ...
                    ce = function (We) {
                        for (var He = 1 << We, tt = (1 << We) + 1, at = We + 1, Ct = Oe(), At = 0; At < He; At += 1)
                        ...
                        for (Vt += 1; Vt < de.length;) {
                            ...
                            Vt += 1,
                                Ct.contains(Bt + Ht) ? Bt = Bt + Ht : (Gt.write(Ct.indexOf(Bt), at), Ct.size() < 4095 && (Ct.size() == 1 << at && (at += 1), Ct.add(Bt + Ht)), Bt = Ht)
                        }
            ...
            Be = function (we, Pe, be) {
                for (var ye = Ee(we, Pe), de = 0; de < Pe; de += 1)
                    for (var xe = 0; xe < we; xe += 1)
                        ye.setPixel(xe, de, be(xe, de));
                var he = pe();
                ye.write(he);
                for (var ce = Re(), Oe = he.toByteArray(), We = 0; We < Oe.length; We += 1)
                    ce.writeByte(Oe[We]);
...
`
    ...
    height: 60px;
    border-radius: ${
    R => borders$3[R.theme.borderRadius]};
    margin-bottom: 8px;
`
,
...
`
    ...
    height: 24px;
    border-radius: ${
    R => badgeBorders[R.theme.borderRadius]};
...
`
    ...
    overflow: hidden;
    color: ${
    R => R.colorPrimary ? R.theme.colors.text.primary : R.theme.colors.text.secondary};
    ${
    media("mobile")} {
        max-width: 80px;
    }
...
`
    ...
    text-align: center;
    color: ${
    R => R.theme.colors.text.secondary};
    margin-top: 0;
    margin-bottom: 32px;
    cursor: default;
`
...
`
    ...
    margin-bottom: 8px;
    border-radius: ${
    R => containerBorders[R.theme.borderRadius]};
...
`
    ...
    height: 20px;
    border-radius: ${
    R => walletBorders[R.theme.borderRadius]};
`,
...
`
    ...
    opacity: 0.08;
    background: ${
    R => R.isShown ? R.theme.colors.icon.secondary : "transparent"};
...
`
    ...
    border-radius: ${
    R => dropdownBorders[R.theme.borderRadius]};
    background-color: ${
    R => R.theme.colors.background.primary}
...
`
    ...
    border: none;
    border-radius: ${
    R => hoverBorders$1[R.theme.borderRadius]};
    cursor: pointer;
...
`
    ...
    box-shadow: 0 4px 24px rgba(0, 0, 0, 0.16);
    border-radius: ${
    R => borders$2[R.theme.borderRadius]};
`,
...
function useOpenedNotifications(R) {
    const {
        timeout: $
    } = __spreadValues(__spreadValues({}, defaultConfig), R),
        [W, U] = createSignal([]),
        [V, K] = createSignal([]);
    return createEffect(on(action, Y => {
        ...
        if (!Y || !Y.showNotification || latestAction() === Y || ((Z = latestAction()) == null ? void 0 : Z.name) === "confirm-transaction" && Y.name === "confirm-transaction")
            return;
        setLatestAction(Y),
            U(oe => oe.filter(re => re.action !== "confirm-transaction"));
        const J = {
            action: Y.name
        };
        U(oe => [...oe, J]);
        const X = setTimeout(() => {
            U(oe => oe.filter(re => re !== J)),
                K(oe => oe.filter(re => re !== X))
        }, $);
        K(oe => [...oe, X])
    })), onCleanup(() => {
...
const computePosition$1 = (R, $, W) => __async(void 0, null, function* () {
    ...
    let X = yield Y.getElementRects({
            ...
            x: oe,
            y: re
        } = computeCoordsFromPlacement(X, U, J),
        ie = U,
        se = {},
        le = 0;
    for (let ue = 0; ue < Z.length; ue++) {
        ...
        if (oe = Se ?? oe, re = Ee ?? re, se = __spreadProps(__spreadValues({}, se), {
                [pe]: __spreadValues(__spreadValues({}, se[pe]), Be)
            }), we && le <= 50) {
            le++,
            typeof we == "object" && (we.placement && (ie = we.placement), we.rects && (X = we.rects === !0 ? yield Y.getElementRects({
                    reference: R,
                    floating: $,
                    strategy: V
                }): we.rects), {
                    x: oe,
                    y: re
                } = computeCoordsFromPlacement(X, ie, J)),
                ue = -1;
            continue
        }
    }
...
function getScale(R) {
    ...
    return (!V || !Number.isFinite(V)) && (V = 1), (!K || !Number.isFinite(K)) && (K = 1), {
        x: V,
        y: K
    }
}
function getBoundingClientRect(R, $, W, U) {
    ...
    const oe = isElement(R) ? getWindow(R) : window,
        re = !isLayoutViewport() && W,
...
function getRectRelativeToOffsetParent(R, $, W) {
    ...
    if (U || !U && W !== "fixed")
        if ((getNodeName($) !== "body" || isOverflowElement(V)) && (Y = getNodeScroll($)), isHTMLElement($)) {
...
function getClippingElementAncestors(R, $) {
    ...
    for (; isElement(Y) && !isLastTraversableNode(Y);) {
        ...
        (K ? !J && !V : !J && Z.position === "static" && !!V && ["absolute", "fixed"].includes(V.position)) ? U = U.filter(oe => oe !== Y): V = Z,
            Y = getParentNode(Y)
    }
    return $.set(R, U), U
}
...
function autoUpdate(R, $, W, U) {
    ...
    if (Y) {
        ...
        oe = new ResizeObserver(() => {
            ...
            isElement(R) && !Z && oe.observe(R),
            !isElement(R) && R.contextElement && !Z && oe.observe(R.contextElement),
            oe.observe($)
    }
    let re,
        ie = Z ? getBoundingClientRect(R) : null;
    Z && se();
    function se() {
        const le = getBoundingClientRect(R);
        ie && (le.x !== ie.x || le.y !== ie.y || le.width !== ie.width || le.height !== ie.height) && W(),
            ie = le,
            re = requestAnimationFrame(se)
    }
    return W(), () => {
        var le;
        X.forEach(ue => {
            ...
            (le = oe) == null || le.disconnect(),
            oe = null,
            Z && cancelAnimationFrame(re)
    }
}
...
function P(R, $, W) {
    ...
    return createEffect(() => {
        let re = R(),
            ie = $();
        if (W == null || W.middleware, U(), V(), re && ie)
    ...
    AccountButton = () => {
        ...
        const pe = $.onStatusChange(Se => {
            ...
            Re = Se => {
                if (!K() || !U())
                    return;
                const Ee = ie().contains(Se.target),
                    Be = X.contains(Se.target);
                !Ee && !Be && V(!1)
            };
        return onMount(() => {
            document.body.addEventListener("click", Re)
        }), onCleanup(() => {
            document.body.removeEventListener("click", Re),
                pe()
                                        ...
                                        return [createComponent(DropdownButtonStyled, {
                                            ...
                                            get children() {
                                                ...
                                                return use(re, Se), Se.style.setProperty("z-index", "999"), Se._$owner = getOwner(), insert(Se, createComponent(Transition, {
                                                    ...
                                                    var Be,
                                                        we;
                                                    const Pe = le.strategy,
                                                        be = `${(Be = le.y) != null ? Be : 0}px`,
...
`
    ...
    border-radius: ${
    R => tgButtonBorders[R.theme.borderRadius]};
    font-size: 16px;
    line-height: 20px;
`
,
...
`
    ...
    height: 32px;
    border-radius: ${
    R => tgIconBorders[R.theme.borderRadius]};
`,
Translation = R => {
    const [$] = useI18n();
    return createMemo(() => {
...
function redirectToTelegram(R, $) {
    ...
    const W = convertToTGDirectLink(R),
        U = new URL(W);
    if (U.searchParams.has("startapp") || U.searchParams.append("startapp", "tonconnect"), isInTMA())
        isTmaPlatform("ios", "android", "macos") ? ($.returnStrategy = "back", $.twaReturnUrl = void 0, sendOpenTelegramLink(addReturnStrategy(U.toString(), $))) : isTmaPlatform("tdesktop") || isTmaPlatform("weba") ? sendOpenTelegramLink(addReturnStrategy(U.toString(), $)) : isTmaPlatform("web") ? ($.returnStrategy = "back", $.twaReturnUrl = void 0, sendOpenTelegramLink(addReturnStrategy(U.toString(), $))) : openLinkBlank(addReturnStrategy(U.toString(), $));
    else if (isOS("ios")) {
        ...
        if ($.returnStrategy = "none", $.twaReturnUrl = void 0, $.forceRedirect)
...
function redirectToWallet(R, $, W, U) {
    if (W = __spreadValues({}, W), isInTMA())
        ...
        isBrowser("chrome") ? (U("universal-link"), openLink(addReturnStrategy(R, W.returnStrategy), "_self")) : (U("universal-link"), openLinkBlank(addReturnStrategy(R, W.returnStrategy)));
    else if (isOS("android"))
...
const DesktopConnectionModal = R => {
        ...
        const ie = () => {
            ...
            ue = () => {
                V(!1),
                    W("extension"),
                    isWalletInfoCurrentlyInjected(R.wallet) && (setLastSelectedWalletInfo(R.wallet), X.connect({
...
FooterStyled = styled.div `
    ...
    R => rgba(R.theme.colors.icon.secondary, .2)};
`,
    ...
    MobileConnectionModal = R => {
        const $ = useTheme(),
            ...
            ie = () => {
                ...
                const Re = !W();
                U(!1),
                    redirectToWallet(oe(), R.wallet.deepLink, {
                        returnStrategy: appState.returnStrategy,
                        forceRedirect: Re
                    }, Se => {
                        setLastSelectedWalletInfo(__spreadProps(__spreadValues({}, R.wallet), {
...
`
    ...
    top: 26px;
    background-color: ${
    R => R.theme.colors.icon.secondary};
    opacity: 0.2;
`
    ,
    ...
    height: 60px;
    border-radius: ${
    R => borders$1[R.theme.borderRadius]};
    display: flex;
    align-items: center;
    justify-content: center;
    background-color: ${
...
`
    ...
    background-color: ${
    R => R.theme.colors.telegramButton};
    color: ${
    R => R.theme.colors.constant.white};
    font-weight: 590;
    font-size: 16px;
    line-height: 20px;
`
...
const _tmpl$$1 = template$1("<li></li>"),
    ...
    MobileUniversalModal = R => {
        ...
        const [ie, se] = createSignal(void 0),
            le = () => __async(void 0, null, function* () {
                ie() !== void 0 && clearTimeout(ie()),
                    yield copyToClipboard(re());
...
`
    ...
    height: 56px;
    border-radius: ${
R => borders[R.theme.borderRadius]};
    &:hover {
        ${
...
styled.li `
    ...
    cursor: pointer;
    border-radius: ${
R => hoverBorders[R.theme.borderRadius]};
    transition: background-color, transform 0.1s ease-in-out;
    &:hover {
        background-color: ${
R => R.theme.colors.background.secondary};
    ...
    WalletsModal = () => {
        ...
        const $ = useContext(ConnectorContext),
            ...
            oe = createMemo(() => {
                ...
                Se = (Ee || []).concat(Be);
                const we = appState.preferredWalletAppName,
                    Pe = Se.find(de => eqWalletName(de, we)),
                    be = Se.filter(de => eqWalletName(de, we)).length >= 2;
                we && Pe && !be && (Se = [__spreadProps(__spreadValues({}, Pe), {
                    isPreferred: !0
                })].concat(Se.filter(de => !eqWalletName(de, we))));
            ...
            ie = createMemo(() => {
                var Se;
                if (!re())
                    return (Se = appState.connectRequestParameters) == null ? void 0 : Se.value
            }),
            se = Se => {
                W.closeModal(Se)
            },
...
ActionModal = R => {
        ...
        const X = () => {
            const oe = action(),
                re = "returnStrategy" in oe ? oe.returnStrategy : appState.returnStrategy,
                ie = !U();
            V(!1),
...
class TonConnectUI {
    ...
    set uiOptions($) {
        ...
        this.checkButtonRootExist($.buttonRootId),
            ...
            (W = $.uiPreferences) != null && W.theme ? ((U = $.uiPreferences) == null ? void 0 : U.theme) !== "SYSTEM" ? ((V = this.systemThemeChangeUnsubscribe) == null || V.call(this), setTheme($.uiPreferences.theme, $.uiPreferences.colorsSet)) : (setTheme(getSystemTheme(), $.uiPreferences.colorsSet), this.systemThemeChangeUnsubscribe || (this.systemThemeChangeUnsubscribe = subscribeToThemeChange(setTheme))) : (K = $.uiPreferences) != null && K.colorsSet && setColors($.uiPreferences.colorsSet),
            (Y = $.uiPreferences) != null && Y.borderRadius && setBorderRadius($.uiPreferences.borderRadius),
            setAppState(Z => {
                var J,
                    X;
                const oe = mergeOptions(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, $.language && {
                    language: $.language
    ...
    sendTransaction($, W) {
        return __async(this, null, function* () {
            if (this.tracker.trackTransactionSentForSignature(this.wallet, $), !this.connected)
                throw this.tracker.trackTransactionSigningFailed(this.wallet, $, "Wallet was not connected"), new TonConnectUIError("Connect wallet to send a transaction.");
            isInTMA() && sendExpand();
            const {
                notifications: U,
                modals: V,
            ...
            const J = () => {
                ...
                oe = this.onTransactionModalStateChange(re => {
                    re != null && re.openModal || (oe(), re || X.abort())
                });
            try {
                const re = yield this.waitForSendTransaction({
                    transaction: $,
                    signal: X.signal
                }, J);
    ...
    connectEmbeddedWallet($) {
        return __async(this, null, function* () {
            const W = V => {
                ...
                U = appState.connectRequestParameters;
            return (U == null ? void 0 : U.state) === "loading" ? this.connectRequestParametersCallback = W : W(U == null ? void 0 : U.value), yield this.waitForWalletConnection({
                ignoreErrors: !1
            })
        })
    }
    ...
    waitForWalletConnection($) {
        return __async(this, null, function* () {
            return new Promise((W, U) => {
                ...
                if (K && K.aborted)
                    return this.tracker.trackConnectionError("Connection was cancelled"), U(new TonConnectUIError("Wallet was not connected"));
                const Y = X => __async(this, null, function* () {
                        if (X)
                            ...
                            if (this.tracker.trackConnectionError("Connection was cancelled"), V)
                                return;
                            J(),
    ...
    waitForSendTransaction($, W) {
        return __async(this, null, function* () {
            return new Promise((U, V) => {
                ...
                if (Y.aborted)
                    return this.tracker.trackTransactionSigningFailed(this.wallet, K, "Transaction was cancelled"), V(new TonConnectUIError("Transaction was not sent"));
    ...
    getModalsAndNotificationsConfiguration($) {
        ...
        let oe = ["before"];
        (V = this.actionsConfiguration) != null && V.modals && (this.actionsConfiguration.modals === "all" ? oe = J : oe = this.actionsConfiguration.modals),
            $ != null && $.modals && ($.modals === "all" ? oe = J : oe = $.modals);
...
function lockPage(R) {
    document.body.style.overflow = R ? "hidden" : "auto",
        document.body.style.marginTop = R ? "100px" : "0",
        document.body.style.height = R ? window.innerHeight + 100 + "px" : "100vh",
        window.scrollTo(0, R ? 100 : 0)
}
function isScreenIsLocked() {
...
class AccountModel {
    ...
    update($) {
        this._data = $,
            $.missions && (this._missions.value = $.missions, this._activeMissions.value = $.missions.active),
    ...
    updateInvoice($) {
        ...
        if (U !== -1)
            return W[U].update($), this.pendingInvoices = [...W], W[U]; {
...
class TapsSubmitService {
    ...
    async loop() {
        ...
        Z && this.app.player.updateBoost(!1),
            (V || K || Z) && (this._next_submit_time = this.calcNextSubmitTime, await this.submitTaps())
    }
    async submitTaps() {
        ...
        try {
            ...
            if (Z instanceof ApiError && Z.status === 400)
...
var define_import_meta_env_default = {
    VITE_APP_BUILD_HASH: "8b1f870",
    VITE_APP_BUILD_DATE: "2024-06-21T14:12:16Z",
    VITE_APP_BUILD_NUM: "631",
    VITE_APP_ENV: "prod",
...
class AppContextValue {
    constructor() {
        ...
        this.log.info("[AppContext] buildHash: 8b1f870"),
            this.log.info("[AppContext] buildDate: 2024-06-21T14:12:16Z"),
            this.log.info("[AppContext] buildNum: 631"),
            this.log.info(`[AppContext] backendUrl: ${this.backendUrl}`),
            this.api.headers.set("x-cv", "631"),
            window.ctx = this,
            window.onerror = (W, U, V, K, Y) => (Y ? this.log.error(Y) : (this.log.error(W), this.log.error(`source: ${U}`), this.log.error(`line: ${V}:${K}`)), !1)
    }
    onApiError($) {
    ...
    getInitData() {
        ...
        if ($)
            return this.log.info("[AppContext] using telegram init_data"), this.log.info($), $;
        if (this.env !== "prod" && this.devInitData)
            return this.log.warn("[AppContext] using dev init_data"), this.log.info(this.devInitData), this.devInitData;
        const W = window.localStorage.getItem("init_data");
        return W ? (this.log.info("[AppContext] using storage init_data"), this.log.info(W), W) : (this.log.error("[AppContext] init_data not found"), "")
    }
    getLoginParams() {
...
const loadingContent = "_loadingContent_t1zxm_1",
